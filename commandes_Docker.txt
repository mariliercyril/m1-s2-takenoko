...
(ou "docker build -t projets2192co/takenokoserver:<tag>", la valeur du "tag" pouvant être pour le serveur, par exemple, "server")

après s'être assuré qu'elle "fonctionnait" :
...
image que l'on pousse alors vers la plate-forme :

	$ ./mvnw dockerfile;push
(ou "docker push projets2192co/takenoko:<tag>")

après s'être assuré qu'elle existait :
