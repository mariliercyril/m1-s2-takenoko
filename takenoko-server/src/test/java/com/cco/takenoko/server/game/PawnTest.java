...
import com.cco.takenoko.server.game.Gardener;
import com.cco.takenoko.server.game.Panda;
...
class PawnTest {
    ...
    private Tile greenTile0 = new Tile(com.cco.takenoko.server.game.tiles.Color.GREEN);
    private Tile greenTile1 = new Tile(com.cco.takenoko.server.game.tiles.Color.GREEN);
    private Tile greenTile2 = new Tile(com.cco.takenoko.server.game.tiles.Color.GREEN);
    private Tile pinkTile0 = new Tile(com.cco.takenoko.server.game.tiles.Color.PINK);
    private Tile yellowTile0 = new Tile(com.cco.takenoko.server.game.tiles.Color.YELLOW);
