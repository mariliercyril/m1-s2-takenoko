...
class TileTest {
    ...
    void setup(@Autowired Game game) {
        g = game;
        g.getBoard().set(new Point(0, 1), new Tile(com.cco.takenoko.game.tiles.Color.GREEN));

        // put down some tiles
        g.getBoard().set(new Point(1, 0), new Tile(com.cco.takenoko.game.tiles.Color.PINK));
